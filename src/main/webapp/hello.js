...
function enableButtons () {
	...
	btn = document.getElementById("input_say_opinion");
	btn.onclick=function(){sayOpinion();};
	btn.value="Click me to know my opinion about you";
}
...
function sayOpinion(){
	var name = document.getElementById("name_field").value;
	var request = gapi.client.helloworldendpoints.sayOpinion({'name':name});
	request.execute(sayHelloCallback);
}
